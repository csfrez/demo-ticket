package com.csfrez.ticket.thread;
...
public class VoteThread extends Thread {
	...
	public void run() {
		...
		while (true) {
			...
			get = new HttpGet("http://www.hnxdf.com/vote/iRadio_vote.asp?VoTeid=215");
			...
			try {
				...
				System.out.println(ipInfo.getIpAddress() + ":" + ipInfo.getPort());
				//System.out.println("-----------------------------------");
